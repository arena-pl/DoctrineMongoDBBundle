...
class ProxyCacheWarmer implements CacheWarmerInterface
{
    ...
    public function warmUp($cacheDir)
    {
        ...
        /* if proxies are autogenerated we don't need to generate them in the cache warmer. For BC reasons we are
         ...
         */
        if ($this->container->getParameter('doctrine_mongodb.odm.auto_generate_proxy_classes')) {
            return;
        }
