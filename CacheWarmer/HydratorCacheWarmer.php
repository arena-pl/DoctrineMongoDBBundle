...
class HydratorCacheWarmer implements CacheWarmerInterface
{
    ...
    public function warmUp($cacheDir)
    {
        ...
        /* if hydrators are autogenerated we don't need to generate them in the cache warmer. For BC reasons we are
         * accepting true/false, once we can break compatibility this should change to constants defined in
         * \Doctrine\ODM\MongoDB\Configuration instead of checking for any truthy value.
         */
        if ($this->container->getParameter('doctrine_mongodb.odm.auto_generate_hydrator_classes')) {
            return;
        }
